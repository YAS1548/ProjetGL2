...
public class ReservationController {
	...
	public void ajouterSalle() {
		 view.afficherMessage("Numero de la salle : ");
		    ...
		    if (type.equals("TP")) {
		        Equipement pc = new EquipementSimple("PC", true);
		        Equipement video = new EquipementSimple("Vidéoprojecteur", true);
		        GroupeEquipement pack = new GroupeEquipement();
		        pack.ajouter(pc);
		        pack.ajouter(video);
		        equipement = pack;
		    } else if (type.equals("Amphi")) {
		        Equipement video = new EquipementSimple("Vidéoprojecteur", true);
		        Equipement micro = new EquipementSimple("Microphone", true);
		        GroupeEquipement pack = new GroupeEquipement();
		        pack.ajouter(video);
		        pack.ajouter(micro);
		        equipement = pack;
		    } else {
		        equipement = new EquipementSimple("Vidéoprojecteur", true);
		    }

		    Salle salle = new Salle(num, capacite, type, equipement);
	...
	public void afficherSalles() {
		...
		for (Salle s : gestion.getSalles()) {
			view.afficherMessage("Salle " + s.getNum() + " | Capacite : " 
				    + s.getCapacite() + " | Type : " + s.getType());

			
				view.afficherMessage("Equipements :");
	...
	public void afficherReservations() {
		...
		for (Reservation r : gestion.getReservations()) {
			view.afficherMessage("Salle " + r.getSalle().getNum() + " | Utilisateur : " + r.getUser().getNom()
					+ " | Heure : " + r.getHeure() + " | Minutes : " + r.getMinutes() + " | Duree (en minutes) : "
					+ r.getDuree());
		}
	}
